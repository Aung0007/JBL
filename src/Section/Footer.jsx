  ...
  return (
    ...
    <footer className='footer'>
        <div className="footer-container container grid">
            <div>
                <a href="" className="footer-logo">JBL</a>
            </div>
            ...
            <div className="footer-data grid">
                <div>
                    ...
                    <ul className="footer-links">
                        ...
                        <li>
                            <a href="" className='footer-link'>Accesories</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul className="footer-links">
                        ...
                        <li>
                            <a href="" className='footer-link'>Update</a>
                        </li>
                        <li>
                            <a href="" className='footer-link'>Provides</a>
                        </li>
                    </ul>
                </div>
                <div className="footer-group">
                    ...
                    <div className="footer-social">
                        ...
                        <a href="https://x.com/" target='_blank' className="footer-social-link">
